...
JOIN
 ...
 -- Select all columns from Warehouse_Equipment_View
SELECT * 
FROM Warehouse_Equipment_View;

-- Select all columns from Volunteers_Shifts_View
SELECT * 
FROM Volunteers_Shifts_View;
